...
favourite15 = Favourite.create ({ user_id: 3, recipe_id: 4 })
favourite16 = Favourite.create ({ user_id: 3, recipe_id: 15 })
favourite17 = Favourite.create ({ user_id: 4, recipe_id: 7 })
favourite18 = Favourite.create ({ user_id: 4, recipe_id: 8 })
favourite19 = Favourite.create ({ user_id: 4, recipe_id: 9 })
...
review10 = Review.create ({ user_id: 5, recipe_id: 1, comment: "Delicious!", rating: 4 })
review10 = Review.create ({ user_id: 10, recipe_id: 2, comment: "Marvelous!!!", rating: 5 })
review10 = Review.create ({ user_id: 10, recipe_id: 3, comment: "Would reccomend every try this recipe!", rating: 5 })
review10 = Review.create ({ user_id: 10, recipe_id: 4, comment: "Mmmm so delicious.", rating: 4 })
review10 = Review.create ({ user_id: 10, recipe_id: 5, comment: "Would like some more direction.", rating: 2 })
review10 = Review.create ({ user_id: 10, recipe_id: 6, comment: "Not too bad.", rating: 3 })
review10 = Review.create ({ user_id: 10, recipe_id: 7, comment: "Tasty, thanks for sharing.", rating: 4 })
review10 = Review.create ({ user_id: 10, recipe_id: 8, comment: "I'm going to try this with my kids.", rating: 4 })
review10 = Review.create ({ user_id: 10, recipe_id: 9, comment: "Yummy!", rating: 5 })
review10 = Review.create ({ user_id: 7, recipe_id: 10, comment: "SO so so good!!!!", rating: 5 })
review10 = Review.create ({ user_id: 10, recipe_id: 1, comment: "Easy to follow.", rating: 4 })
review10 = Review.create ({ user_id: 9, recipe_id: 2, comment: "Great dessert!", rating: 5 })
