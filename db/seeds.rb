...
time: 70,
number_of_servings: 6,
instructions: "Prep: Preheat the oven to 350°F, and grease an 8×5-inch loaf pan with baking spray. Dry Ingredients: Whisk the flour, baking powder, salt, and baking soda. Wet Ingredients: Cream the coconut oil, applesauce, and sugar with a stand or hand mixer. Add the egg and vanilla and beat at medium speed until thick. Scrape down the sides of the bowl. Combine: Add half of the dry ingredients and blend on low speed until combined. Pour in the remaining flour mixture and the mashed bananas and blend on low, ensuring you don’t overmix. Bake: Pour the batter into the loaf pan and bake on the center rack for 45 to 50 minutes or until a toothpick comes out clean but moist. Serve: Let the pan cool for at least 10 minutes, then turn it over to remove the loaf from the pan. The bread should be at room temperature before slicing to ensure it doesn’t fall apart.",
country: 'Canada',
...
time: 45,
number_of_servings: 6,
instructions: "Marinate and cook prawns in garlic to oil, then boil with the remaining ingredients, and serve!",
