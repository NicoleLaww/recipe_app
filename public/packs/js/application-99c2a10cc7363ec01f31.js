...
document.addEventListener("turbolinks:load", function () {
  ...
  sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire('Hello SweetAlert2');
  showAlerts('.alert-notice', 'success');
  showAlerts('.alert-danger', 'error');
});
function showAlerts(selector, icon) {
  jquery__WEBPACK_IMPORTED_MODULE_4___default()(selector).each(function () {
    sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
      icon: icon,
      text: jquery__WEBPACK_IMPORTED_MODULE_4___default()(this).text(),
      timer: 5000,
      toast: true,
      position: 'top-end',
...
/******/ });
//# sourceMappingURL=application-99c2a10cc7363ec01f31.js.map